	...
	void SetAutoSeq(void)
	{
		if (Code1868){
			RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 0, 0.5); //foward
								RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, -1, 0.9); //turn left
								RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 0, 1.7); //foward
								RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25,  1, 1); //turn right
#if 0
			switch(AUTON_CASE){
				case (AUTON_CORNER_RIGHT):
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 0, 0.5); //foward
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 1, 0.7); //turn right
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 0, 1.3); //foward
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, -1, 1); //turn left
					//RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, 0, 0, 60); //stop
					break;
				case (AUTON_CORNER_LEFT):
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 0, 0.5);//foward
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, -1, 0.7); //turn left
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 0, 1.3); //foward
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 1, 1); //turn right
					//RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, 0, 0, 60); //stop
					break;
				case (AUTON_SIDE_RIGHT):
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 0, 0.5); //foward
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 1, 0.9); //turn right
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, 0, 1.2); //foward
					RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, -0.25, -1, 1); //turn left
					//RAWCLib::AutoAddSeq(DRIVE_USING_VALUES, 0, 0, 60); //stop
